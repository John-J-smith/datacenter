...
#define PARAM_ITEM_LIST(X) \
    ...
    PARAM_INT(X, PARAM_DAY_SWTIME, 7u, PARAM_STORE_RAM_EE_BK) \
    PARAM_INT(X, PARAM_FEE_SWTIME, 7u, PARAM_STORE_RAM_EE_BK) \
    PARAM_INT(X, PARAM_LADDER_SWTIME, 7u, PARAM_STORE_RAM_EE_BK) \
    PARAM_INT(X, PARAM_UN, 4u, PARAM_STORE_RAM_EE_BK) \
    PARAM_INT(X, PARAM_IB, 4u, PARAM_STORE_RAM_EE_BK) \
    PARAM_INT(X, PARAM_IMAX, 4u, PARAM_STORE_RAM_EE_BK) \
    PARAM_ARRAY(X, PARAM_HOLIDAY_DATA, 5u, 12u, PARAM_STORE_RAM_EE) \
    PARAM_LINK(X, PARAM_CALIB_DATA, 8u, 12u, PARAM_STORE_RAM_EE)
